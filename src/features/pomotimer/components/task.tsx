...
export default function Task() {
  ...
  return (
    <div className="col-span-1 bg-slate-700 border-2 border-slate-300 rounded-md flex flex-col h-full overflow-hidden">
      ...
      <div className="p-4 bg-slate-800 border-b border-slate-600 flex items-center gap-2 sticky top-0 z-10">
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          <DialogTrigger asChild>
            <Button
              size="icon"
              className="bg-green-500 hover:bg-green-600 h-9 w-9 shrink-0"
            >
